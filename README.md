...
| `merge_commit_title` | `MERGE_MESSAGE` | Matches GitHub's API default; set explicitly to prevent perpetual plan diffs |
| `merge_commit_message` | `PR_TITLE` | Matches GitHub's API default; set explicitly to prevent perpetual plan diffs |
