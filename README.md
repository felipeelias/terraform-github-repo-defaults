...
| `merge_commit_title` | `PR_TITLE` | Default merge commit title; set explicitly to prevent perpetual plan diffs |
| `merge_commit_message` | `PR_BODY` | Default merge commit message; set explicitly to prevent perpetual plan diffs |
