...
```hcl
module "my_repo" {
  source = "github.com/felipeelias/terraform-github-repo-defaults?ref=v0.4.1"
...
| <a name="input_codeql"></a> [codeql](#input\_codeql) | CodeQL default setup configuration (uses gh CLI, no native TF resource) | <pre>object({<br/>    enabled     = optional(bool, false)<br/>    query_suite = optional(string, "default")<br/>  })</pre> | `{}` | no |
